...
public class ActivityPractice6x6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practice6x6);
    ...
    private void calculate() {
        if(firstCard == secondCard) {
            ...
            score.setText("Scores: " + player_str_score);
            matches++;
        } else {
